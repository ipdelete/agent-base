...
class TestSystemPromptLoading:
    ...
    def test_load_default_prompt_from_package(self, mock_settings):
    ...
    def test_load_custom_prompt_from_file(self, custom_prompt_settings, custom_prompt_file):
        """Test loading custom prompt from file specified in config."""
        agent = Agent(custom_prompt_settings)
        prompt = agent._load_system_prompt()
    ...
    def test_placeholder_replacement(self, mock_settings, tmp_path):
    ...
    def test_missing_placeholders_ignored(self, mock_settings, tmp_path):
    ...
    def test_user_default_system_prompt(self, mock_settings, tmp_path):
    ...
    def test_fallback_on_corrupt_prompt_file(self, mock_settings, tmp_path, caplog):
    ...
    def test_hardcoded_fallback_on_package_failure(self, mock_settings, caplog):
    ...
    def test_empty_prompt_file_uses_fallback(self, mock_settings, tmp_path, caplog):
    ...
    def test_prompt_with_partial_placeholders(self, mock_settings, tmp_path):
    ...
    def test_yaml_front_matter_stripped(self, mock_settings, tmp_path):
...
Model: {{MODEL}}
    ...
    def test_unresolved_placeholders_logged(self, mock_settings, tmp_path, caplog):
    ...
    def test_env_var_expansion_in_path(self, mock_settings, tmp_path, monkeypatch):
